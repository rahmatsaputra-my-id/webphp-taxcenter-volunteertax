            ...
            <div class="content-page">
              <div class="row">
                ...
                <div class="col-md-3 col-sm-3 sidebar2">
                  <h2>Kontak Kami</h2>
                  <address>
                    <strong>Tax Center Gunadarma.</strong><br>
                    Kampus D Universitas Gunadarma<br>
                    Jl. Margonda Raya No 100, Kota Depok<br>
                    <abbr title="Phone">P:</abbr> 021-7888-111-2 ext : 110
                  </address>
                  <address>
                    <strong>Email</strong><br>
                    <a href="mailto:taxcenter@gunadarma.ac.id">taxcenter@gunadarma.ac.id</a><br>
                  ...
                  <h2 class="padding-top-30">Tentang Kami</h2>

...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Baitul Maal Wa Tamwil | Login</title>
            ...
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <div class="login-bg" style="background-image:url(<?=base_url('assets/backend');?>/assets/pages/img/login/bg1.jpg)">
                        <img class="login-logo" src="<?=base_url('assets/backend');?>/assets/pages/img/login/logo.png" style="width:300px;height:80px" /> </div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        <h1>Baitul Maal Wa Tamwil Login</h1>
                        <p> Lorem ipsum dolor sit amet, coectetuer adipiscing elit sed diam nonummy et nibh euismod aliquam erat volutpat. Lorem ipsum dolor sit amet, coectetuer adipiscing. </p>
                        <!-- javascript:; -->
                        <form action="<?=base_url();?>admin/login/cek_login" class="login-form" method="post" >
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; Baitul maal wa tamwil 2017</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<![endif]-->
        ...
        <script src="<?=base_url('assets/backend');?>/assets/pages/scripts/login-5.min.js" type="text/javascript"></script>

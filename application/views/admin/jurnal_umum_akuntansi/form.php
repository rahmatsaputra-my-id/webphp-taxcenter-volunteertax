  ...
  <input id="idf" value="3" type="hidden" />		        
       ...
       <div class="form-group">
            ...
            <div class="col-xs-2">
                ...
                <input placeholder="No Jurnal" class="form-control input-sm" name="no_bukti" type="text"  id="no_bukti" value="<?php echo $r['no_transaksi'];?>"  />
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
               ...
               <textarea name="uraian" class="form-control input-sm" id="uraian" placeholder="keterangan" ><?php echo $r['keterangan'];?></textarea>
        ...
        if($aksi=="edit")
            ...
            <?php				
                    ...
                    <div class="col-md-3"><input type="text" class="form-control form-group hitung total-debet" id="debet-<?php echo $rd->id;?>" name="debet_e[<?php echo $rd->id;?>]" value="<?php echo $rd->debet; ?>"  /></div>
                    <div class="col-md-3"><input type="text" class="form-control form-group hitung total-kredit" id="kredit-<?php echo $rd->id;?>" name="kredit_e[<?php echo $rd->id;?>]" value="<?php echo $rd->kredit; ?>"  />
  ...
  <?php if ($aksi=="create"){ ?>
                                        ...
                                        <div class="form-group" id="srow1">
                                          <input id="akunke" value="1" type="hidden" />    
                                            ...
                                            <div class="col-sm-3">
                                              <input placeholder='Debet'  type='text' class='form-control hitung total-debet' id="debet-0" name='debet[]'/>
                                            </div>
                                            <div class="col-sm-3">
                                                <input placeholder='Kredit'  type='text' class='form-control hitung total-kredit' id="kredit-0" name='kredit[]'/>
                                        ...
                                        <div class="form-group" id="srow2"> 
                                            ...
                                            <div class="col-sm-3">
                                              <input placeholder='Debet'  type='text' class='form-control hitung total-debet' id="debet-1" name='debet[]'/>
                                            </div>
                                            <div class="col-sm-3">
                                                <input placeholder='Kredit'  type='text' class='form-control hitung total-kredit' id="kredit-1" name='kredit[]'/>
  ...
  <?php  }?>
                                        ...
                                        <div class="form-group"> 
                                          <div class="col-sm-5">
                                            ...
                                            <div class="col-sm-3">
                                              <input type='text' class='form-control pull-right' placeholder='Debet' name="alltotal" id="totaldebet" readonly="readonly"/>
                                            </div>
                                            <div class="col-sm-3">
                                              <input type='text' class='form-control pull-right' placeholder='Kredit' name="alltotal" id="totalkredit" readonly="readonly"/>
                                              <input type='hidden' class='form-control pull-right' placeholder='Balance' name="alltotal" id="total" readonly="readonly"/>
                                            </div>
                                        </div>
</div>
</div>
        ...
        <div class="form-group">
            <div class="col-xs-12" style="padding-left:80px;padding-right:40px;">
              <a class="btn green btn-sm"  onclick="addRincian('<?=base_url();?>'); return false;"><i class="glyphicon glyphicon-plus"></i> Tambah Baris</a> 
...
$('body').on('focus', '.hitung', function() {
    ...
    $(this).keydown(function() {
        setTimeout(function() {
            ...
            if (!isNaN(subtotal)) {
                $('#debet-' + berhitung[1]).val(subtotal);
                var alltotal = 0;
                $('.total-debet').each(function(){
                  alltotal += parseFloat($(this).val());
                });
                $('#totaldebet').val(alltotal);
            }
        }, 50);
    });
});
...
$('body').on('focus', '.hitung', function() {
    ...
    $(this).keydown(function() {
        setTimeout(function() {
            var satuan = ($('#kredit-' + berhitung[1]).val() != '' ? $('#kredit-' + berhitung[1]).val() : 0),
                subtotal = parseInt(satuan);
            if (!isNaN(subtotal)) {
                $('#kredit-' + berhitung[1]).val(subtotal);
                var alltotal = 0;
                $('.total-kredit').each(function(){
                  alltotal += parseFloat($(this).val());
                });
                $('#totalkredit').val(alltotal);
            }
        }, 50);
    });
});

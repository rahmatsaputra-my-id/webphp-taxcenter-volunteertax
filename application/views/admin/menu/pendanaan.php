                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <div class="tiles">
                                <a href="<?=base_url('home/createsimpanan');?>">
                                    <div class="tile bg-blue-hoki">
                                        <div class="tile-body">
                                            <i class="fa fa-plus"></i>
                                        </div>
                                        <div class="tile-object">
                                            <div class="name"> Entry Simpanan </div>
                                        </div>
                                    </div>
                                </a>
                                <!--<a href="<?php //=base_url('home/simpanan');?>">
                                    <div class="tile double bg-red-sunglo">
                                        <div class="tile-body">
                                            <i class="fa fa-eye"></i>
                                        </div>
                                        <div class="tile-object">
                                            <div class="name"> Jurnal Transaksi Simpanan </div>
                                        </div>
                                    </div>
                                </a>-->
                                <a href="<?=base_url('home/createpenarikan');?>">
                                    <div class="tile bg-blue-hoki">
                                        <div class="tile-body">
                                            <i class="fa fa-plus"></i>
                                        </div>
                                        <div class="tile-object">
                                            <div class="name"> Entry Penarikan </div>
                                        </div>
                                    </div>
                                </a>
                                <!--<a href="<?php //=base_url('home/penarikan');?>">
                                    <div class="tile double bg-red-sunglo">
                                        <div class="tile-body">
                                            <i class="fa fa-eye"></i>
                                        </div>
                                        <div class="tile-object">
                                            <div class="name"> Jurnal Transaksi Penarikan </div>
                                        </div>
                                    </div>
                                </a>-->
                                <a href="<?=base_url('home/posting_nisbah');?>">
                                    <div class="tile bg-red-sunglo">
                                        <div class="tile-body">
                                            <i class="fa fa-plus"></i>
                                        </div>
                                        <div class="tile-object">
                                            <div class="name"> Posting Nisbah </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="<?=base_url('home/daftar_jurnal_pendanaan');?>">
                                ...
                                <form action="<?=base_url().'home/transaksi_anggota';?>" method="post" name="frmJurnal" id="frmJurnal" class="form-horizontal" enctype="multipart/form-data">

...
?>
  ...
  <input id="idf" value="1" type="hidden" />		        
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
                <label for="NamaLengkap" class="control-label col-xs-4">No Simpanan</label>
                <div class="col-xs-8">
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-8">
                	<input type="text" name="tanggal_transaksi" value="<?php echo $r['tanggal_transaksi'];?>" class="form-control" id="mask_date2" placeholder="" <?=($aksi=='view') ? 'disabled': ''; ?>>
                </div>
            </div>
          </div>
        </div>

              ...
              <table class="table table-striped table-hover">
                ...
                <tbody>
                                ...
                                <tr <?php echo $cls;?>>
                                  ...
                                  <td><strong><?php echo $r->no_bukti;?></strong></td>
                                  <td><strong><?php echo $r->tanggal_transaksi;?></strong></td>
                                  <td colspan="2"><strong><?php echo $r->uraian;?></strong></td>
                                  <td align="center">&nbsp;</td>
                                  <td align="center">&nbsp;</td>
                                </tr>
                              <?php
                                $rincian=$this->db->query('SELECT tbl_ju_detail.*,kepala_akun,klasifikasi_akun,kode_akun,nama_akun FROM tbl_ju_detail LEFT JOIN data_akun b ON coa=b.id WHERE header='.$r->id);
                            ...
                            ?>
                              <tr>
                                ...
                                <td align="right"><?php $this->db->select_sum('debet');$query2 = $this->db->get($total_debet);foreach ($query2->result() as $r3 ){echo number_format($r3->debet,0,",",".");}?></td>
                                <td align="right"><?php $this->db->select_sum('kredit');$query3 = $this->db->get($total_kredit);foreach ($query3->result() as $r4 ){echo number_format($r4->kredit,0,",",".");}?></td>
                                <td></td>
                              </tr>
                  </tbody>
              </table>

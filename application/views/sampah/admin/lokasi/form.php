                                ...
                                <div class="portlet-body">
                                    <div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="nama_lokasi" value="<?=$nama_lokasi;?>" class="form-control" placeholder="" <?=($aksi=='view') ? 'disabled': ''; ?>>
                                      </div>
                                      <div class="form-group">
                                        <label>Alamat</label>
                                        ...
                                        <div class="col-md-12">
                                            <label>Penanggung Jawab</label>
                                                ...
                                                <div class="col-md-3">
                                                  ...
                                                  <input class='form-control' type="text" onKeyUp="suggest1(this.value);" name="kode_akun[]" onBlur="fill21();" id="kode_akun1" value="<?=$no_kta;?>" <?=($aksi=='view') ? 'disabled': ''; ?>/>
                                                  <div class="result">

...
?>
  ...
  <input id="idf" value="3" type="hidden" />		        
        ...
        <div class="col-xs-2"><a type="button" class="btn btn-default" name="add" href="<?=base_url($link2);?>"><i class="fa fa-chevron-left fa-fw"></i>Kembali</a></div>
                                          ...
                                          <div class="row">
                                            <div id="srow1">
                                              <div class="col-sm-6">
                                                <div class="form-group">
                                                  <label class="control-label col-xs-4">Dari Akun (Kredit)</label>
                                                  <div class="col-xs-8">
                                        ...
                                        <div class="row">
                                            <div id="srow1">
                                              <div class="col-sm-6">
                                                <div class="form-group">
                                                  <label class="control-label col-xs-4">Ke Akun (Debet)</label>
                                                  <div class="col-xs-8">
                                        ...
                                        function suggest2(inputString){
                                          if(inputString.length == 0){
                                            ...
                                            $.post("<?=base_url();?>/home/suggest_akun_bank/"+inputString+"/2", {queryString:""+inputString+""}, function(data){
                                              if(data.length>0){
                                                $('#suggestions2').fadeIn();
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    <input placeholder="No Transfer" class="form-control" name="no_transaksi" type="text"  id="no_transaksi" value="<?php echo $r['no_transaksi'];?>"  />
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
                <label for="NamaLengkap" class="control-label col-xs-4">Nominal</label>
                <div class="col-xs-8">
                <input placeholder='Debet'  type='hidden' class='form-control hitung' id="debet-1" name='debet[]' value='0'/>
                <input placeholder='Nominal'  type='text' class='form-control hitung' id="kredit-1" name='kredit[]' value="<?php echo $r['sebesar'];?>"/>
                <input type="hidden" name="subtotal[]" id="total-1" class="total" readonly="readonly">

                <input placeholder='Kredit'  type='hidden' class='form-control' name='kredit[]' value='0'/>
                <input placeholder="Debet" class="form-control" name="debet[]" type="hidden" id="total" value="<?php echo $r['sebesar'];?>"/>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
                <label for="NamaLengkap" class="control-label col-xs-4">Referensi</label>
                <div class="col-xs-8">
                    <input placeholder="No Referensi" class="form-control" name="no_referensi" type="text"  id="no_referensi" value="<?php echo $r['no_referensi'];?>"  />
                </div>
            </div>
          </div>
        </div>

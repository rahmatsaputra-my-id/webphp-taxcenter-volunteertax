        <?php if($aksi=='edit'){
            ...
            $fax                    = $list->fax;
            $email                  = $list->email;
            $bulan_awal_periode     = $list->bulan_awal_periode;
            $bulan_akhir_periode    = $list->bulan_akhir_periode;
        }
        }elseif($aksi=='create'){?>
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="tabbable-line tabbable-custom-profile">
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li>
                                                        <a href="#tab_1_33" data-toggle="tab"> Periode Akuntansi </a>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <?php foreach ($query2->result() as $list2) { ?>
                                                    <!--tab-pane-->
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="hidden-xs"> <?=$bulan_awal_periode;?> </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            Tahun
                                                                        </td>
                                                                        <td class="hidden-xs"> <?=$list2->kode_periode;?> </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            Tutup Buku Akhir Tahun
                                                                        </td>
                                                                        <td class="hidden-xs"> <?=$bulan_akhir_periode;?> </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>

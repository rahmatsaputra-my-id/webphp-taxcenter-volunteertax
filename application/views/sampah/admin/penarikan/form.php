        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    <input placeholder="No Penarikan" class="form-control" name="no_transaksi" type="text"  id="no_bukti" value="<?php echo $r['no_transaksi'];?>"  />
                </div>
            </div>
          </div>
          <div class="col-md-6">
    ...
    ?>
       ...
       <div class="form-group">
        <label for="NamaLengkap" class="control-label col-xs-1 ckeditor"></label>
           ...
           <div class="col-xs-9">
        <!--<a class="btn green btn-sm"  onclick="addRincian('<?php //echo $sl_coa;?>'); return false;"><i class="glyphicon glyphicon-plus"></i> Tambah Akun</a>--> 
      </div>
        </div>  
                                          ...
                                          <input id="akunke" value="1" type="hidden" />    
                                            ...
                                            <div class="col-sm-5">
                                              ...
                                              <div class="result"><div class="suggestionsBox" id="suggestions1" style="display: none;"><img src="<?=base_url();?>assets/backend/bmt/arrow.png" style="position: relative; top: -12px; left: 30px;" alt="upArrow" />
                                                    <div class="suggestionsList" id="suggestionsList1">&nbsp;</div></div></div>
                                              <input placeholder='Nama Akun'  type='hidden' class='form-control' name='nama_akun' onBlur="fill11();" id="nama_akun1" disabled/>
                                              <input placeholder='Kredit'  type='hidden' class='form-control hitung' id="debet-1" name='debet[]'/>
...
<script type="text/javascript">
    function cek_database(){
        ...
        $.ajax({
            ...
            var json = data,
            obj = JSON.parse(json);
            $('#coa2').val(obj.akun_kasbank1);
            $('#coa1').val(obj.akun_simpanan);

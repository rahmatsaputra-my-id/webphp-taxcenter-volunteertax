...
<!-- Main content -->
                                              ...
                                              <div class="mt-radio-inline">
                                                <input type="hidden" name="tipe" value="kepala_akun" onclick="javascript:yesnoCheck();" id="kepala" <?php if ($tipe=="kepala_akun"){echo "checked";}else{echo "checked";} ?>>
                                                  <label class="mt-radio">
                                                      <input type="radio" name="tipe" value="Tanah Bangunan" onclick="javascript:yesnoCheck();" id="klasifikasi" <?php if ($tipe=="Tanah Bangunan"){echo "checked";}else{echo "";} ?>> Tanah/Bangunan
                                                      <span></span>
                                                  </label>
                                                  ...
                                                  <label class="mt-radio"><!--mt-radio-disabled-->
                                                      <input type="radio" name="tipe" value="lainnya" onclick="javascript:yesnoCheck();" id="namaakun" <?php if ($tipe!="Tanah Bangunan" && $tipe!="Kendaraam" && $tipe!=""){echo "checked";}else{echo "";} ?>> Lainnya
                                                      <span></span>
                                                  </label>
                                              </div>
        ...
        <div class="row form-group">
          <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-8">
                  <input type="text" id="lainnya" name="tipe" value="<?=$tipe;?>" class="form-control" placeholder="Lainnya" <?=($aksi=='view') ? 'disabled': ''; ?>>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label class="control-label col-xs-2">Nilai Jaminan</label>
              <div class="col-xs-8">
        ...
        <div class="row form-group">
          <div class="col-md-6">
            <div class="form-group">
                <label class="control-label col-xs-4">Dokumen Jaminan</label>
                <div class="col-xs-8">
          ...
          <div class="col-md-6">
            <div class="form-group">
                <label class="control-label col-xs-2">Nomor</label>
                <div class="col-xs-8">
        ...
        <div class="row form-group">
          <div class="col-md-6">
            <div class="form-group">
              <label for="NamaLengkap" class="control-label col-xs-4">Kegunaan</label>
              <div class="col-xs-8">
                  <div class="mt-radio-inline">
                    <input type="hidden" name="kegunaan" value="kepala_akun" onclick="javascript:yesnoCheck();" id="kepala" <?php if ($tipe=="kepala_akun"){echo "checked";}else{echo "checked";} ?>>
                      <label class="mt-radio">
                          <input type="radio" name="kegunaan" value="Modal Kerja" onclick="javascript:yesnoCheck();" id="klasifikasi" <?php if ($tipe=="Modal Kerja"){echo "checked";}else{echo "";} ?>> Modal Kerja
                          <span></span>
                      </label>
                      <label class="mt-radio"><!--mt-radio-disabled-->
                          <input type="radio" name="kegunaan" value="Investasi" onclick="javascript:yesnoCheck();" id="namaakun2" <?php if ($tipe=="Investasi"){echo "checked";}else{echo "";} ?>> Investasi
                          <span></span>
                      </label>
                      <label class="mt-radio"><!--mt-radio-disabled-->
                          <input type="radio" name="kegunaan" value="Konsumtif" onclick="javascript:yesnoCheck();" id="namaakun3" <?php if ($tipe=="Konsumtif"){echo "checked";}else{echo "";} ?>> Konsumtif
                          <span></span>
                      </label>
                      <label class="mt-radio"><!--mt-radio-disabled-->
                          <input type="radio" name="kegunaan" value="lainnya" onclick="javascript:yesnoCheck();" id="namaakun" <?php if ($tipe!="Modal Kerja" && $tipe!="Investasi" && $tipe!="Konsumtif" && $tipe!=""){echo "checked";}else{echo "";} ?>> Lainnya
                          <span></span>
                      </label>
                  </div>
              </div>
        ...
        <div class="row form-group">
          <div class="col-md-6">
            <div class="form-group">
                <label class="control-label col-xs-4"></label>
                <div class="col-xs-8">
                  <input type="text" placeholder="Lainnya" id="lainnya" name="tipe" value="<?=$tipe;?>" class="form-control" <?=($aksi=='view') ? 'disabled': ''; ?>>
                </div>
            </div>
          </div>
        </div>
        <h3 class="">Data Angsuran</h3>
        <div class="row form-group">
          <div class="col-md-6">
            <div class="form-group">
              <label class="control-label col-xs-4">Periode</label>
              <div class="col-xs-8">
        ...
        <div class="row form-group">
          <div class="col-md-6">
            <div class="form-group">
              <label class="control-label col-xs-4">Jangka Waktu</label>
              <div class="col-xs-8">
        ...
        <div class="row form-group">
          <div class="col-md-6">
            <div class="form-group">
              <label class="control-label col-xs-4">Jatuh Tempo</label>
              <div class="col-xs-8">
        ...
        <div class="row form-group">
          <div class="col-md-6">
            <div class="form-group">
              <label class="control-label col-xs-4">Total Angsuran</label>
              <div class="col-xs-8">

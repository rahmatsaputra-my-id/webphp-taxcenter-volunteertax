                              ...
                              <tbody>
                                ...
                                <tr <?php echo $cls;?>>
                                  ...
                                  <td align="center">
                                    ...
                                    <a class="btn btn-danger" name="delete" href="<?=base_url($linkdelete.$r->id);?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"><i class="fa fa-trash fa-fw"></i></a></td>
                                </tr>
                              <?php

                                            ...
                                            <div id="srow3">
                                              <div class="col-sm-6">
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-xs-8">
                                                    <input placeholder='ID Akun'  type='hidden' class='form-control' name='pengirim' onBlur="fill33();" id="id_akun3" />
  ...
  <?php  }?>
        ...
        <div class="form-group">
            <div class="col-xs-12" style="padding-left:80px;padding-right:40px;">
              <a class="btn green btn-sm"  onclick="addRincian2('<?=base_url();?>'); return false;"><i class="glyphicon glyphicon-plus"></i> Tambah Baris</a> 

                                    ...
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <th width="40%">:&nbsp;<?php $saldo_akhir=$saldo_awal+$debet-$kredit;echo number_format($saldo_akhir,0,",",".");?></th>
                                                <th width="10%" style="text-align:'right';">Mutasi :</th>
                                                <th width="15%"><?php $mutasi=$debet-$kredit;echo number_format($mutasi,0,",",".");?></th>
                                                <th width="15%"></th>
                                            </tr>
                                        </tfoot>
                                        <tbody>
